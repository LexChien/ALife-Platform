...
class Boids:
    def __init__(
        ...
        self._active_phase_override = None
    ...
    def set_active_phase(self, name: str | None):
        """Explicitly override the current phase for live interaction."""
        self._active_phase_override = name
    ...
    def _active_phase_control(self):
        ...
        phase_name = self._active_phase_override
        if not phase_name and self.phase_specs:
        ...
        if phase_name:
            for control in controller.get("phases", []):
                if control.get("name") == phase_name:
                    return control
        return {}
